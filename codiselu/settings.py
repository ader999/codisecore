...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-juqh_khg4tumcgovtxo3zo++7u9#ne+o*kbsln5clqe%10nwu)')
...
# Hardening de Seguridad para Entorno de Producción
if not DEBUG:
