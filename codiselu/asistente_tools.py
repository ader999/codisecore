...
def buscar_eventos(
    ...
    for e in qs[:10]:
        resultados.append({
            ...
            "solo_este_ano": e.solo_este_ano,
            "rango_celebracion": e.rango_celebracion,
            "rango_celebracion_en": e.rango_celebracion_en or e.rango_celebracion,
            "rango_celebracion_zh": e.rango_celebracion_zh or e.rango_celebracion,
